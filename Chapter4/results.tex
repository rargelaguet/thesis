...
MOFA+ identified 7 Factors that explain at least 1\% of variance in a group and all together capture between 35\% and 55\% of the total transcriptional heterogeneity per embryo (\Cref{fig:mofa2_scrna_variance_explained}).
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\linewidth]{mofa2_scrna_ExE_ectoderm_factor}
	\caption[]{
