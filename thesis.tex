...
\input{Preamble/preamble} % Contains packages and user-defined commands and settings
...
\usepackage[font={small}, margin=20pt]{caption}
\usepackage[font={footnotesize}, margin=20pt]{subcaption}
...
\include{Chapter2/bayes}
\include{Chapter2/factor_analysis}
\include{Chapter2/mofa}
