...
One of the essential components that underlies MOFA is the use of an ARD prior aimed at disentangling the activity of factors across views (see \Cref{section:ard} and \Cref{mofa:model_description}).\\
